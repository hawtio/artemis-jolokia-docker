...
run:
	docker run --rm -p 8161:8161 -p 8778:8778 -p 61616:61616 --name artemis tadayosi/artemis:latest
...
deploy-openshift:
	...
	oc create deploy artemis --image=docker.io/tadayosi/artemis:latest
